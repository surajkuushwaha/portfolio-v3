...
export const DATA = {
  ...
  stats: [
    { v:"50", u:"M+", l:"Weekly requests handled",
      cap:"That's roughly 80 requests every second — at all hours, for every brand on the platform.",
      hero:true, ic:"pulse" },
    { v:"200", u:"+", l:"Enterprise brands served",
      cap:"From a single MVP to 200+ paying companies — scaled without re-platforming.",
      ic:"brands" },
    { v:"0", u:"", l:"Production downtime",
      cap:"30+ database migrations, zero customer impact. Reliability you can quote in a contract.",
      ic:"shield" },
    { v:"4", u:"yrs", l:"Shipping in production",
      cap:"Day-0 engineer at a venture-backed SaaS — ownership from first commit to today.",
      ic:"calendar" },
    { v:"₹", u:"", l:"Revenue-critical systems",
      cap:"Built the billing, reporting, and onboarding pipelines that every customer touches daily.",
      ic:"trend" },
  ],
  about: [
